    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <h2 class="mb-4">What is TRIPBEEP?</h2>

	            <p>Tripbeep is a Carpooling, Bikepooling & Sending or Carrying Parcel application which facilitates ride sharing and parcel carrying by giving a choice to user either to offer or find rides  </p>

                <h2 class="mb-4">What is Car Pooling/Bike Pooling OR Sending Parcel? </h2>
	            <p>Car Pooling/Bike Pooling refers to sharing of empty seats in vechile. People driving from one point to another point can share the empty seats with others who would like to travel on the same route. and if they wish to carry parcel then they can accept the parcel request also for the same route. </p>
