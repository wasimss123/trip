...
<html lang="en">
 ...
 <li class="nav-item"><a href="parcel/searchp.php" class="nav-link"> Send a Parcel</a></li>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/car18.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
	  
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>How to Publish a Ride and Book a ride <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">How to Publish a Ride and Book a ride</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/car20.jpg);">
					</div>
					
					<div class="col-md-6 wrap-about ftco-animate">
	          <div class="heading-section heading-section-white pl-md-5">
	          	<!-- <span class="subheading">How to Publish a Ride and Book a ride</span>
	            <h2 class="mb-4">How to Publish a Ride and Book a ride</h2>
	            ...
	            <p>Affordable and comfortable to travel, from city-to-city even at the last minute. </p>
 -->

	            <p>1. How can i register for the service? <br> It's quite simple! signup using your phone number after visiting our website. after veryfiying your phone number. Enter your profile details too complete registration. you are all set to post your first ride & enjoy our service.</p>

                <p>2. How do i publish rides? <br> Before publishing your rides, you have to give the details of your vechile which include the registration number and type or modal of your car. After saving those details, you can publish a ride by entering to and from location details. If there are any ride seekers looking for rides in your route, they will send a request to you. After that you can accept their request. Boom! Your ride is ready!</p>

	            <p>3. Book A ride <br> Once your account verification is complete, you can find a ride by enteriing to and from location details. After posting the ride, you will get matches with carpool gives travelling in the same route. The Start and End point of carpool giver, number of seats availabe will be mentioned. You can send on invite to ride with them.</p>
	          </div>
					</div>
				</div>
			</div>
