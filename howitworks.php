      ...
      <div class="container">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>How it works <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <h2 class="mb-4">How does TRIPBEEP work?</h2>
	            ...
	            <p>1. Find Ride <br> Just enter your departure & arrival points and your travel date, then choose a car owner going your way. if you have question you can ask before booking. <br>Check out the car owner's trusted profiles, including ratings let for them by other member trust and safety!</p>
                <p>2. Book Online <br> Book your seat online. You'll get the car owner's phone number to arrange the final details. <br> you can also contact the car owners via private message once you've booked your seat.</p>

	            <p>3. Travel together <br> Bring exact change to pay the car owner the agreed contribution during the ride. <br> remember to leave a rating for the car owner after the ride, it means they're more likey to leave one for you!</p>
	          </div>
					</div>
				</div>
			</div>
